...
<head>
    ...
    <title>Bootstrap Employee Template-Employee Pannel</title>
	<!-- BOOTSTRAP STYLES-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index" style="font-size:28px">Employee Panel</a> 
            </div>
            ...
            <nav class="navbar-default navbar-side" role="navigation">
				<div class="sidebar-collapse">
					<ul class="nav" id="main-menu">
						...
						<li>
							<a  href="#"><i class="fa fa-user fa-3x"></i> Category </a>
							<ul class="nav nav-second-level">
						 
								<li>
									<a class="nav-link"  href="add_cate"><i class="fa fa-table"></i>Add Category</a>
								</li>
						...
						<li>
							<a  href="#"><i class="fa fa-user fa-3x"></i> Flavours </a>
							<ul class="nav nav-second-level">
						 
								<li>
									<a class="nav-link"  href="add_flav"><i class="fa fa-table"></i>Add Flavours</a>
								</li>
								
								<li>
									<a  href="manage_flav"><i class="fa fa-table"></i>Manage Flavours</a>
								</li>
						...
						<li>
							<a  href="manage_feed"><i class="fa fa-edit fa-3x"></i> Feedback </a>
						</li>
