        ...
        <div class="row">
            ...
            <div class="topnav">
				...
				<div class="search-container" style="border: 5px solid navy;padding:240px;border-style:groove;">
					...
					<h3 style="position:absolute;left:190px;top:345px;font-family:'sans-serif';color:darkblue">1.Tea-Bread & Butter</h3>
					
					<p style="position:absolute;left:170px;top:410px;font-family:'Lucida Sans Unicode';color:goldenrod;font-size:22px"><b>Add Task</b></p>
					<form action="" method="post">
						<h4 style="position:absolute;left:230px;top:435px;font-family:'Lucida Sans Unicode';"><b>Task:</b></h4>
						<select name="food" style="position:absolute;left:296px;top:440px;padding:6px 70px">
							<option value="-1"></option>
							<option value="1">Breakfast</option>
							<option value="2">Lunch</option>
							<option value="3">Dinner</option>
						</select>
						<button type="submit" name="submit" style="position:absolute;left:300px;top:477px;border-radius:6px;padding:3px 20px"><b>Add Task</b></button>
					</form>
					
					<p style="position:absolute;left:170px;top:520px;font-family:'Lucida Sans Unicode';color:goldenrod;font-size:22px"><b>Delete Task</b></p>
					<form action="" method="post">
						<h4 style="position:absolute;left:230px;top:545px;font-family:'Lucida Sans Unicode';"><b>Task:</b></h4>
						<select name="food" style="position:absolute;left:296px;top:550px;padding:6px 50px">
							<option value="-1"></option>
							<option value="1">1.Tea-Bread & Butter</option>
							<option value="2">2.Sandwich & Juice</option>
							<option value="3">3.Coffee & Muffin</option>
							<option value="1">4.Fruit-Salad & Milk-shake</option>
						</select>
						<button type="submit" name="submit" style="position:absolute;left:300px;top:587px;border-radius:6px;padding:3px 20px"><b>Delete Task</b></button>
					</form>
