    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index">Furniture</a>
            </div>
                ...
                <ul class="nav" id="main-menu">
                    <li>
                        <div class="user-img-div">
                            <img src="Projects/Project-2/Admin-pannel/Admin/assets/img/image-1.jpeg" class="img-thumbnail" />
                    ...
                    <li>
                        <a href="blank"><i class="fa fa-user"></i>Feedback</a>
                    </li>
