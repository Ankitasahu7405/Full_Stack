...
<main id="main" class="main">
    ...
    <section class="section">
		<div class="row">
			...
			<div class="card">
				<div class="card-body">
				<h5 class="card-title text-danger">MANAGE PRODUCT</h5>
				...
				<table class="table table-hover">
					...
					<tbody>
						...
						?>
							<tr>
								<td scope="row"><?php echo $d->prod_id;?></td>
								<td><?php echo $d->cate_id;?></td>
								<td><?php echo $d->prod_name;?></td>
								<td><img src="product<?php echo $d->prod_image;?>" height="100px" width="100px"></td>
