...
function Contact() {
    ...
    const fetch = async ()=>{
   const respons = await axios.get(`http://localhost:3000/contacts`)
   console.log(respons);
...
function validation() {
  ...
  if(res.status == 201){
   ...
   setFormvalue({...formvalue , id :"" , name: "",email :"" ,  comment: "" , Subject : "" , Message :""  })
  }
   }
}
    return (
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 pt-5 pb-lg-5">
                            <div className="contact-form bg-light p-4 p-lg-5 my-lg-5">
                                ...
                                <div id="success" />
                                <form name="sentMessage" onSubmit={submithandle} id="contactForm" noValidate="novalidate">
                                    <div className="form-row">
                                        <div className="col-sm-6 control-group">
                                            ...
                                            className="form-control border-0 p-4" id="name" placeholder="Your Name" required="required" data-validation-required-message="Please enter your name" />
                                        ...
                                        <div className="col-sm-6 control-group">
                                            ...
                                            className="form-control border-0 p-4" id="email" placeholder="Your Email" required="required" data-validation-required-message="Please enter your email" />
                                            <p className="help-block text-danger" />
                                        </div>
                                    </div>
                                    <div className="control-group">
                                        ...
                                        className="form-control border-0 p-4" id="subject" placeholder="Subject" required="required" data-validation-required-message="Please enter a subject" />
                                        <p className="help-block text-danger" />
                                    </div>
                                    <div className="control-group">
                                        <textarea
                                           onChange={onchagehandle}
                                           name='comment'
                                           value={formvalue.comment} className="form-control border-0 py-3 px-4" rows={3} id="message" placeholder="Message" required="required" data-validation-required-message="Please enter your message" defaultValue={""} />
                                        <p className="help-block text-danger" />
                                    </div>
                                    <div>
