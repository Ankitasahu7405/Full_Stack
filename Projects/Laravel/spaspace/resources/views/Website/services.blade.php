				...
				<div class="container py-lg-4">
					<div class="content-info-in row">
						...
						<div class="content-right col-lg-6">
							<img src="{{url('Website/assets/images/ab6.jpg')}}" class="img-fluid" alt="">
						</div>
			...
			<div class="row w3-services-grids">
				<div class="col-lg-4 col-md-6 luxe-grid">
					<div class="luxe-grid-info">
						<a href="blog-single"><img src="{{url('Website/assets/images/ab1.jpg')}}" class="img-fuild" alt=""></a>
				...
				<div class="col-lg-4 col-md-6 luxe-grid">
					<div class="luxe-grid-info">
						<a href="blog-single"><img src="{{url('Website/assets/images/ab2.jpg')}}" class="img-fuild" alt=""></a>
						<a href="#" class="cause-title-wrap">
				...
				<div class="col-lg-4 col-md-6 luxe-grid">
					<div class="luxe-grid-info">
						<a href="blog-single"><img src="{{url('Website/assets/images/ab3.jpg')}}" class="img-fuild" alt=""></a>
						<a href="#" class="cause-title-wrap">
	...
	<section class="w3l-index2">
		<div class="row abouthy-img-grids no-gutters">
			<div class="col-md-6 img-one">
				<img src="{{url('Website/assets/images/ab.jpg')}}" alt=" " class="img-fluid">
			</div>
			<div class="col-md-6 img-one content-mid py-md-0 py-5">
				<div class="info">
					...
					<div class="ready-more">
						<a class="btn btn-style btn-primary" href="services">Services</a>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6 img-one">
				<img src="{{url('Website/assets/images/ab1.jpg')}}" alt=" " class="img-fluid">
			</div>
		</div>
	</section>
	<!-- /w3l-content-grids-->
							...
							<div class="w3l-pricing-7  pric-7-1">
								...
								<div class="w3l-pricing-7-bottom">
									...
									<div class="buy-button text-center">
										<div class="read">
											<a href="contact" class="btn btn-style btn-primary mt-4">Buy Now</a>
										</div>
									</div>
								</div>
							</div>
