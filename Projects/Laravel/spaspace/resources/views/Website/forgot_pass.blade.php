			...
			<div class="container py-lg-3">
				<div class="top-map">
					<div class="map-content-9">
						<div class="form-top1">
							<h6 class="sub-title text-center">Change Password</h6>
							<h3 class="hny-title text-center mb-lg-5 mb-4">Change Here!</h3>
							<form action="{{url('/pass_auth')}}" method="post">
							@csrf	
								...
								<div class="form-group">
									<input type="password" name="password" style="margin-top:30px" class="form-control" id="exampleInputPassword1" placeholder="New Password">
									@error('password')
										<div class="alert alert-danger">{{ $message }}</div>
									@enderror
								</div>
								...
								<div class="form-group">
									<input type="password" name="confirm_password" style="margin-top:30px" class="form-control" id="exampleInputPassword1" placeholder="Confirm Password">
