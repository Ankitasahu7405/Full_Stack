						...
						<div class="form-top1">
							...
							@csrf								
								<div class="form-group">
									<input type="password" name="password" style="margin-top:30px" class="form-control" id="exampleInputPassword1" placeholder="Old Password">
									@error('password')
										<div class="alert alert-danger">{{ $message }}</div>
									@enderror
								</div>
								<div class="form-group">
									<input type="password" name="new_password" style="margin-top:30px" class="form-control" id="exampleInputPassword1" placeholder="New Password">
									@error('new_password')
										<div class="alert alert-danger">{{ $message }}</div>
									@enderror
								</div>
